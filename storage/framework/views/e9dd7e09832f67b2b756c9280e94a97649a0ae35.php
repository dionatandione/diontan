                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('clientes.store')); ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="telefone" type="text" class="form-control" name="telefone" value="<?php echo e(old('telefone')); ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projeto\resources\views/clientes/create.blade.php ENDPATH**/ ?>